...
public class Controllerlogin extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
           ...
           String action=request.getParameter("nuevacuenta");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getParameter("btningresar")!=null){
            ...
            HttpSession session=request.getSession();
            switch(dao.logeo(nombre, contra)){
                case 1:
        ...
        String namae=request.getParameter("nombreusu");
        ...
        if(request.getParameter("action2")!=null){
            dao.newcliente(iduser, contras, namae, dni, domicilio, correo);
            request.getRequestDispatcher("login.jsp").forward(request, response);
        }
